 ...
 def mini(_self,_e):
  ...
  for k in range(0,_self.NUMGAUSS):
   ...
   for i in range(0,_self.NUMNODE):
    ...
    dxdl1[k] += float(_self.x[ii])*float(dNdl1[k][i])   # dx/dl1 = x1*dN1/dl1 + x2*dN2/dl1 + x3*dN3/dl1 ...
    dydl1[k] += float(_self.y[ii])*float(dNdl1[k][i])   # dy/dl1 = y1*dN1/dl1 + y2*dN2/dl1 + y3*dN3/dl1 ...
    dxdl2[k] += float(_self.x[ii])*float(dNdl2[k][i])   # dx/dl2 = x1*dN1/dl2 + x2*dN2/dl2 + x3*dN3/dl2 ...
    dydl2[k] += float(_self.y[ii])*float(dNdl2[k][i])   # dy/dl2 = y1*dN1/dl2 + y2*dN2/dl2 + y3*dN3/dl2 ...
